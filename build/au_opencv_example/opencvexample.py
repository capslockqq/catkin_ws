...
def do_full(image,hsv,upper,lower,debug=True):
    """
...
#red_bricks1 = do_full(image,hsv,upper_red1,lower_red1)
#red_bricks2 = do_full(image,hsv,upper_red2,lower_red2)
#black_bricks = do_full(image,hsv,upper_black,lower_black)




#show_bricks(image,black_bricks,(0,0,255))
show_bricks(image,blue_bricks,(255,0,0))
#show_bricks(image,green_bricks,(0,255,0))
#show_bricks(image,yellow_bricks,(0,255,255))
#show_bricks(image,red_bricks1,(0,0,255))
#show_bricks(image,red_bricks2,(255,0,0))
